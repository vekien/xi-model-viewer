...
const MENUS = [
  {
    ...
    items: [
      ...
      { id: 'update-database', label: 'Update Database', icon: 'database' },
      { id: 'import-database', label: 'Import Database…', icon: 'drive_folder_upload' },
      { id: 'export-database', label: 'Export Database…', icon: 'table_view' },
