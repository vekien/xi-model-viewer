 ...
 * trio, and the `cast` the Effects view composes from one) — the weapons stay
 * sheathed for a spell; whether the cast schedule then hides them is the
 * scheduler's ShowHideWeapon tag (js/weaponVis.js). Trailing digit =
 * body-region part. Everything else — the battle stance, the attack rounds,
 * a weapon skill's routine — is the character engaged.
 */
